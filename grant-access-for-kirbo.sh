...
step "Adding the contents of 'https://gitlab.com/kirbo/dotfiles/raw/master/.ssh/keys/MBP2019.pub' into '${HOME}/.ssh/authorized_keys'"
curl -s https://gitlab.com/kirbo/dotfiles/raw/master/.ssh/keys/MBP2019.pub >> $HOME/.ssh/authorized_keys
